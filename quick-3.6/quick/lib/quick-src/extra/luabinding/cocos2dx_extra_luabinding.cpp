...
** Generated automatically by tolua++-1.0.92 on Tue Dec  8 13:39:02 2015.
*/
...
/* method: setTag of class  HTTPRequest */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_HTTPRequest_setTag00
static int tolua_cocos2dx_extra_luabinding_HTTPRequest_setTag00(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
/* method: getTag of class  HTTPRequest */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_HTTPRequest_getTag00
static int tolua_cocos2dx_extra_luabinding_HTTPRequest_getTag00(lua_State* tolua_S)
{
#if COCOS2D_DEBUG >= 1
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua_cocos2dx_extra_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,"cc");
  ...
  tolua_beginmodule(tolua_S,"HTTPRequest");
   ...
   tolua_function(tolua_S,"setTag",tolua_cocos2dx_extra_luabinding_HTTPRequest_setTag00);
   tolua_function(tolua_S,"getTag",tolua_cocos2dx_extra_luabinding_HTTPRequest_getTag00);
  tolua_endmodule(tolua_S);
