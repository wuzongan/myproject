...
int lua_dragonbones_DBCCArmature_registerAnimationEventHandler(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "db.DBCCArmature:registerAnimationEventHandler");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmature_registerFrameEventHandler(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "db.DBCCArmature:registerFrameEventHandler");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmatureNode_registerAnimationEventHandler(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "db.DBCCArmatureNode:registerAnimationEventHandler");
        if(!ok)
        {
...
int lua_dragonbones_DBCCArmatureNode_registerFrameEventHandler(lua_State* tolua_S)
{
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "db.DBCCArmatureNode:registerFrameEventHandler");
        if(!ok)
        {
