...
int lua_cocos2dx_cocosbuilder_CCBAnimationManager_setAnimationCompletedCallback(lua_State* tolua_S)
{
    int argc = 0;
    cocosbuilder::CCBAnimationManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_cocosbuilder_CCBAnimationManager_setAnimationCompletedCallback'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_object<cocos2d::CallFunc>(tolua_S, 3, "cc.CallFunc",&arg1);
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_cocosbuilder_CCBAnimationManager_setAnimationCompletedCallback'", nullptr);
            return 0;
        }
        cobj->setAnimationCompletedCallback(arg0, arg1);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "cc.CCBAnimationManager:setAnimationCompletedCallback",argc, 2);
    return 0;
