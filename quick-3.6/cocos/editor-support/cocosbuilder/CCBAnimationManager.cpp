...
//     }
    ...
    //update wza
    CC_SAFE_RELEASE(_animationCompleteCallbackFunc);
...
void CCBAnimationManager::setAnimationCompletedCallback(Ref *target, CallFunc *callbackFunc) {
    // if (target)
    // {
    //     target->retain();
    // }
    ...
    CC_SAFE_RELEASE(_animationCompleteCallbackFunc);
    _animationCompleteCallbackFunc = callbackFunc;
    _animationCompleteCallbackFunc->retain();
}
...
void CCBAnimationManager::sequenceCompleted()
{
    ...
    if (_animationCompleteCallbackFunc) {
        // (_target->*_animationCompleteCallbackFunc)();
        _animationCompleteCallbackFunc->execute();
    }
}
