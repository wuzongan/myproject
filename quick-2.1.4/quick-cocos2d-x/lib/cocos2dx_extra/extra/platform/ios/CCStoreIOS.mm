 ...
 = CCStorePaymentTransactionWrapper::createWithTransaction(transaction);
    ...
    switch (transaction.transactionState)
    {
        ...
        case SKPaymentTransactionStatePurchased:
            ...
            //添加by xiaolinfu 添加base64编码
            receiptDataLength = transaction.transactionReceipt.base64Encoding.length;
            receiptData = utf8cstr(transaction.transactionReceipt.base64Encoding);
            break;
