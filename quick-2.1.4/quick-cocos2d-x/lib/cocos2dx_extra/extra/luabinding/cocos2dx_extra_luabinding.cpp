...
** Generated automatically by tolua++-1.0.92 on Sat Feb  8 10:08:36 2014.
*/
...
/* method: getSystemVersion of class  CCNative */
#ifndef TOLUA_DISABLE_tolua_cocos2dx_extra_luabinding_CCNative_getSystemVersion00
static int tolua_cocos2dx_extra_luabinding_CCNative_getSystemVersion00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
 ...
 {
  {
   const string tolua_ret = (const string)  CCNative::getSystemVersion();
   tolua_pushcppstring(tolua_S,(const char*)tolua_ret);
  }
 }
 return 1;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'getSystemVersion'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_cocos2dx_extra_luabinding_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CCNative");
   ...
   tolua_function(tolua_S,"getSystemVersion",tolua_cocos2dx_extra_luabinding_CCNative_getSystemVersion00);
