...
//    SEL_CallFunc mAnimationCompleteCallbackFunc;
    CCCallFunc* mAnimationCompleteCallbackFunc;
    CCArray *mParticles;
    CCObject *mTarget;
...
//    void setAnimationCompletedCallback(CCObject *target, SEL_CallFunc callbackFunc);
    void setAnimationCompletedCallback(CCObject *target, CCCallFunc* callbackFunc);
    ...
    void addParticle(CCNode *node);
    CCArray* getParticles();
private:
