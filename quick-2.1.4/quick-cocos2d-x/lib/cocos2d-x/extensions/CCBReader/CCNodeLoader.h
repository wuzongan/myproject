...
class CCNodeLoader : public CCObject {
    ...
    protected:
		...
		//add by xiaolinfu
		virtual CCTexture2D * parsePropTypeTexture2(CCNode * pNode, CCNode * pParent, CCBReader * pCCBReader,CCRect &rect);
		...
		//add by xiaolinfu
		 virtual void onHandlePropTypeTexture2(CCNode * pNode, CCNode * pParent, const char* pPropertyName, CCTexture2D * pCCTexture2D,CCRect &rect, CCBReader * pCCBReader);
