...
bool AppDelegate::applicationDidFinishLaunching()
{
	...
	register_all_cocos2dx_custom(stack->getLuaState());
#if ANYSDK_DEFINE > 0
    ...
    {
		CCLOG("not _launchMode%s", ConfigParser::getInstance()->getEntryFile().c_str());
...
void AppDelegate::applicationWillEnterForeground()
{
	...
	//LuaPlatform::luaFunc("applicationWillExit", "{}");
	CustomClass::luaFunc();
}
