...
function i64u(x)
    return ( ( (bit32.rshift(x,1) * 2) + bit32.band(x,1) ) % (0xFFFFFFFF+1));
...
function i64_and(a,b)
    local o = {}; o.l = i64u( bit32.band(a.l, b.l) ); o.h = i64u( bit32.band(a.h, b.h) ); return o;
end

function i64_or(a,b)
    local o = {}; o.l = i64u( bit32.bor(a.l, b.l) ); o.h = i64u( bit32.bor(a.h, b.h) ); return o;
end

function i64_xor(a,b)
    local o = {}; o.l = i64u( bit32.bxor(a.l, b.l) ); o.h = i64u( bit32.bxor(a.h, b.h) ); return o;
end

function i64_not(a)
    local o = {}; o.l = i64u( bit32.bnot(a.l) ); o.h = i64u( bit32.bnot(a.h) ); return o;
end
...
function i64_lshift(a,n)
    ...
    if(n==0) then
        ...
        if(n<32) then
            o.l = i64u(bit32.lshift(a.l, n)); o.h = i64u(bit32.lshift(a.h, n)) + bit32.rshift(a.l, (32 - n));
        else
            o.l = 0; o.h = i64u( bit32.lshift( a.l, (n-32)));
        end
    end
    return o;
end
...
function i64_rshift(a,n)
    ...
    if(n==0) then
        ...
        if(n<32) then
            o.l = bit32.rshift(a.l, n) + i64u( bit32.lshift(a.h, (32-n))); o.h=bit32.rshift(a.h, n);
        else
            o.l = bit32.rshift(a.h, (n-32)); o.h=0;
        end
    end
    return o;
end
